...
class Board:
    def __init__(self):
        ...
        for i in range(0,8):
            self.board[i][1].set_piece(Pawn(self.board,self.board_black_attack,"P","w",i,1))
            self.board[i][6].set_piece(Pawn(self.board,self.board_white_attack,"P","b",i,6))
        self.board[1][0].set_piece(Knight(self.board,self.board_black_attack,"N","w",1,0))
        self.board[6][0].set_piece(Knight(self.board,self.board_black_attack,"N","w",6,0))
        self.board[1][7].set_piece(Knight(self.board,self.board_white_attack,"N","b",1,7))
        self.board[6][7].set_piece(Knight(self.board,self.board_white_attack,"N","b",6,7))
        self.board[2][0].set_piece(Bishop(self.board,self.board_black_attack,"B","w",2,0))
        self.board[5][0].set_piece(Bishop(self.board,self.board_black_attack,"B","w",5,0))
        self.board[2][7].set_piece(Bishop(self.board,self.board_white_attack,"B","b",2,7))
        self.board[5][7].set_piece(Bishop(self.board,self.board_white_attack,"B","b",5,7))
        self.board[0][0].set_piece(Rook(self.board,self.board_black_attack,"R","w",0,0))
        self.board[7][0].set_piece(Rook(self.board,self.board_black_attack,"R","w",7,0))
        self.board[0][7].set_piece(Rook(self.board,self.board_white_attack,"R","b",0,7))
        self.board[7][7].set_piece(Rook(self.board,self.board_white_attack,"R","b",7,7))
        self.board[3][0].set_piece(Queen(self.board,self.board_black_attack,"Q","w",3,0))
        self.board[3][7].set_piece(Queen(self.board,self.board_white_attack,"Q","b",3,7))
        self.board[4][0].set_piece(King(self.board,self.board_black_attack,"K","w",4,0))
        self.board[4][7].set_piece(King(self.board,self.board_white_attack,"K","b",4,7))
        #
        #
        for i in range(0,8):
        ...
        self.board[3][0].piece.cells_attacked(self.board_white_attack,3,0,"attack")
        self.board[3][7].piece.cells_attacked(self.board_black_attack,3,7,"attack")
        self.board[4][0].piece.cells_attacked(self.board_white_attack,4,0,"attack")
        self.board[4][7].piece.cells_attacked(self.board_black_attack,4,7,"attack")
